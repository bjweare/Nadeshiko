...
#  dialogues_gtk.sh
#  Nadeshiko-do-postponed dialogues implemented with Python and Glade.
...
glade_file="$MODULESDIR/nadeshiko-do-postponed/dialogues_gtk.glade"
py_file="$MODULESDIR/nadeshiko-do-postponed/dialogues_gtk.py"
